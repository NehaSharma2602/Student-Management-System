...
<head>
    <meta charset="UTF-8">
    <title>Add New Student | Academia Connect</title>
    ...
    <div class="container">
        ...
        <div class="right-panel">
            <div class="form-header">
                ...
                <p>Please fill in all required fields to register a new student</p>
            </div>
            
            <form action="add_student" method="post" enctype="multipart/form-data" class="staff-form" id="staffForm">
                <!-- Name Field -->
                ...
                <div class="form-group">
                    ...
                    <small style="color: #666; display: block; margin-top: 5px;">Default password can be changed later by the student</small>
                </div>
                
                <!-- Designation Field -->
                <div class="form-group">
                    <label class="form-label">Semester <span class="required">*</span></label>
                    <select name="semester" class="select-control" required>
                ...
                <div class="form-group">
                    ...
                    <select name="branch" class="select-control" required>
