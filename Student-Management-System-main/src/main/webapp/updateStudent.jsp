...
<html>
<head>
    <title>Edit Student | Academia Connect</title>
    ...
    <div class="form-container">
        ...
        <div class="staff-preview">
            <div class="profile-image-container">
                <img src="${pageContext.request.contextPath}/images/${student.profilePic}" 
                     alt="${student.name}" 
                     class="profile-img"
                     onerror="this.src='https://ui-avatars.com/api/?name=${student.name}&background=1a2a6c&color=fff&size=150'">
            ...
            <div class="staff-info">
                <div class="staff-name">${student.name}</div>
                <div class="staff-designation">${student.semester}</div>
                <div class="staff-department">${student.branch}</div>
            </div>
        </div>
        ...
        <div class="edit-form">
            <div class="form-header">
                ...
                <p>Update student information and profile picture</p>
            </div>
            
            <form action="UpdateStudentServlet" method="post" enctype="multipart/form-data" id="editForm">
                <!-- Hidden Fields -->
                <div class="hidden-inputs">
                    <input type="hidden" name="id" value="${student.id}">
                    <input type="hidden" name="oldImg" value="${student.profilePic}">
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            <i class="fas fa-user-tie"></i> Semester
                        </label>
                        <div class="input-with-icon">
